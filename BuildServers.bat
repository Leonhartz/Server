...
echo Automatically building Servers... (please wait)

%1 -batchmode -projectPath "%CD%" -executeMethod AutoBuild.Servers -quit

if not errorlevel 1 (
	echo You can now open the Servers folder
) else (
